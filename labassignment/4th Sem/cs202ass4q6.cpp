...
{
    Node *head = NULL;
    insertNewNodeAtTail(head, 'a');
    insertNewNodeAtTail(head, 'f');
    insertNewNodeAtTail(head, 'z');
    insertNewNodeAtTail(head, 'y');
    insertNewNodeAtTail(head, 'j');
    showAllData(head);
    deleteLargestNode(head);
    showAllData(head);
    return 0;
}