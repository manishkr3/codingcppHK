...
void subtractPolynomials(Node *head1, Node *head2)
{
    ...
    else if (head1->power == head2->power)
    {
        ...
        subtractPolynomials(head1->next, head2->next);
    }
    else if (head1->power > head2->power)
    {
        cout << " " << head1->coeff << "x^" << head1->power << " ";
        subtractPolynomials(head1->next, head2);
    }
    else
    {
        cout << " " << head2->coeff << "x^" << head2->power << " ";
        subtractPolynomials(head1, head2->next);
    }
}
...
int main()
{
    ...
    cout << endl
         << "Addition:" << endl;
    subtractPolynomials(head1, head2);
    return 0;
}
